    ...
    for set in sets:
        ...
        for problem in set.problems:  # Your agent will solve one problem at a time.
            ...
            # if i == 12:
                ...
                result = problem.name + "," + str(problem.givenAnswer) + "," + problem.getCorrect() + "," + str(
                ...
                #    results.write("%s\n" % result)
        setResult = set.name + "," + str(set.getTotal("Correct")) + "," + str(set.getTotal("Incorrect")) + "," + str(
            set.getTotal("Skipped"))
        setResults.write("%s\n" % setResult)
    results.close()
    setResults.close()
